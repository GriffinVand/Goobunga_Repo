...
#define FID_Users_griff_Documents_GitHub_Goobunga_Repo_Goobunga_Source_Goobunga_Quests_QuestManagerComponent_h_18_DELEGATE \
static void FOnEnemyKilled_DelegateWrapper(const FMulticastScriptDelegate& OnEnemyKilled, FName EnemyType);


#define FID_Users_griff_Documents_GitHub_Goobunga_Repo_Goobunga_Source_Goobunga_Quests_QuestManagerComponent_h_19_DELEGATE \
static void FOnItemCollected_DelegateWrapper(const FMulticastScriptDelegate& OnItemCollected, FName ItemType);


#define FID_Users_griff_Documents_GitHub_Goobunga_Repo_Goobunga_Source_Goobunga_Quests_QuestManagerComponent_h_20_DELEGATE \
