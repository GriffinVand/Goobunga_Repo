...
void EmptyLinkFunctionForGeneratedCodeGoobunga_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Goobunga()
	{
		if (!Z_Registration_Info_UPackage__Script_Goobunga.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Goobunga_OnShopCloseInput__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Goobunga_OnStateChanged__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Goobunga(Z_Construct_UPackage__Script_Goobunga, TEXT("/Script/Goobunga"), Z_Registration_Info_UPackage__Script_Goobunga, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x6C927AEA, 0xCAE9AF3D));
