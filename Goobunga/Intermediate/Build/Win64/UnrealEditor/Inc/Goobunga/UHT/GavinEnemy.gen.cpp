...
struct Z_CompiledInDeferFile_FID_Goobunga_Repo_Goobunga_Source_Goobunga_Enemies_GavinEnemy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGavinEnemy, AGavinEnemy::StaticClass, TEXT("AGavinEnemy"), &Z_Registration_Info_UClass_AGavinEnemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGavinEnemy), 4006058721U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Goobunga_Repo_Goobunga_Source_Goobunga_Enemies_GavinEnemy_h_551009253(TEXT("/Script/Goobunga"),
