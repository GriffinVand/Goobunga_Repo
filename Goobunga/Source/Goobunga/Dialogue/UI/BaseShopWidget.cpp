...
void UBaseShopWidget::AddShopItem(const TObjectPtr<UItemData>& Item, bool bOwned)
{
	if (ShopItemClass)
	{
		...
		ShopItemGrid->AddChildToUniformGrid(NewItem, ChildCount/ItemsPerRow, ChildCount%ItemsPerRow );
